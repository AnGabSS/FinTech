...
<div class="container">
    <h1 class="text-center m-5" style="background-color: rgb(13, 110, 253);">Formulário de Registro de Serviços</h1>
    ...
    <input type="hidden" name="acao" value="cadastrar">
        <div class="col-sm-12 col-md-12 p-4">
            ...
            <div class="d-flex justify-content-end">
                <button class="btn btn-primary" type="submit" value="Salvar">Adicionar Serviço</button>
            </div>
        </div>
    </form>
</div>
